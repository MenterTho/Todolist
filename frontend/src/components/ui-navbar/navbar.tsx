...
export default function Navbar() {
  ...
  const [activeDropdown, setActiveDropdown] = useState<"notif" | null>(null);
      ...
      <nav className="fixed top-0 left-0 w-full z-20 bg-white/10 backdrop-blur-md border-b border-white/10 rounded-b-2xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {isOpen && (
            <div
              ref={mobileMenuRef}
              className="md:hidden bg-white/90 backdrop-blur-md border-t border-white/10 animate-slideInDown"
            >
